...
if(mysqli_num_rows($query)>0)
{
    while($rows=mysqli_fetch_assoc($query)){
        ...
        <div class="row">
                        ...
                        for($i=1;$i<=$rowcount;$i++)
                        {
                            ...
                            if($i==1)
                            {
                                ...
                                <div class="item active">
                                    <img class="d-block img-fluid" src="<?php echo $photo ?>" alt="First slide" width="100%" style="max-height: 600px; min-height: 600px;">
                                </div>
                                <?php
                            }
                            else
            ...
            <div class="col-sm-6">
                <center><h2><?php echo $rows['street'] ?></h2></center>
                <div class="row">
                    <div class="col-sm-6">
