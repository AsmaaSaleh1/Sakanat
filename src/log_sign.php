...
<!--        <script src="https://kit.fontawesome.com/a81368914c.js"></script>-->
    ...
    " >
                    ...
                    <form action="auth.php"  class="sign-in-form" method="post" id="login">
                        ...
                        <div class="actual-form">
                            ...
                            <button type="submit" name="login" value="Sign In" class="btn btn-primary sign-btn">Login <span></span></button>
